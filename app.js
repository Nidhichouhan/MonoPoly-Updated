...
var arrdiv = [box1, box2, box3, box4, box5, box8, box9, box12, box13, box14, box15, box16]
...
function changePosition_1(old, currentPos) {
    ...
    let template = `<img src="./images/images (1).jpg" id="img11" alt="red" style="width:20px;">`;
...
function changePosition_2(old, currentPos) {
    ...
    let template = `<img src="./images/images (2).jpg" id="img12" alt="red" style="width:17px;">`;
    arrdiv[newPosition].innerHTML += template;
